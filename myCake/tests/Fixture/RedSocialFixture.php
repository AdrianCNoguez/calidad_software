 ...
 * RedSocialFixture
 */
class RedSocialFixture extends TestFixture
{
    /**
     * Table name
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'red_social_ibfk_1' => ['type' => 'foreign', 'columns' => ['equipo_id'], 'references' => ['equipo', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
