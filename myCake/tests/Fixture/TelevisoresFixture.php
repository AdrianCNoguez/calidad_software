 ...
 * TelevisoresFixture
 */
class TelevisoresFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'televisores_ibfk_1' => ['type' => 'foreign', 'columns' => ['medios_id'], 'references' => ['medios', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
