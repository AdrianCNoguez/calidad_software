 ...
 * EstadioFixture
 */
class EstadioFixture extends TestFixture
{
    /**
     * Table name
     *
    ...
    public $fields = [
        ...
        'sede' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish2_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'estadio_ibfk_1' => ['type' => 'foreign', 'columns' => ['direccion_id'], 'references' => ['direccion', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
