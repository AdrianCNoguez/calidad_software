...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        ?></li>
        <li><?= $this->Html->link(__('List Director'), ['action' => 'index']) ?></li>
...
<div class="director form large-9 medium-8 columns content">
    ...
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->control('tiempo_club');
            echo $this->Form->control('Liguillas');
            echo $this->Form->control('TorneosEquipo');
        ?>
    </fieldset>
